...
Add https://github.com/takezoe/gitbucket/releases/download/4.3-1/gitbucket.war /usr/local/tomcat/webapps/ROOT.war
RUN (cd /usr/local/tomcat/webapps; ln -s ROOT.war gitbucket-4.3-1)
