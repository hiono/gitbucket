...
Add https://github.com/takezoe/gitbucket/releases/download/3.14/gitbucket.war /usr/local/tomcat/webapps/ROOT.war
RUN (cd /usr/local/tomcat/webapps; ln -s ROOT.war gitbucket-3.14)
